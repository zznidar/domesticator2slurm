...
def copy_over_fasta_file(file_name: str, in_folder: str, out_folder: str, dry_run: bool = False) -> tuple[str, str]: #dry_run is seto to 0 which means the comand goes through
